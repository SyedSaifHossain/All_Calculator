...
class scientificFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        tvsec = rootView.findViewById<TextView>(R.id.idTVSecondary)
        tvMain = rootView.findViewById(R.id.idTVprimary)
        bac = rootView.findViewById(R.id.bac)
        bc = rootView.findViewById(R.id.bc)
        bbrac1 = rootView.findViewById(R.id.bbrac1)
        bbrac2 = rootView.findViewById(R.id.bbrac2)
        bsin = rootView.findViewById(R.id.bsin)
        bcos = rootView.findViewById(R.id.bcos)
        btan = rootView.findViewById(R.id.btan)
        blog = rootView.findViewById(R.id.blog)
        bln = rootView.findViewById(R.id.bln)
        bfact = rootView.findViewById(R.id.bfact)
        bsquare = rootView.findViewById(R.id.bsquare)
        bsqrt = rootView.findViewById(R.id.bsqrt)
        binv = rootView.findViewById(R.id.binv)
        ...
        bpi = rootView.findViewById(R.id.bpi)
        bmul = rootView.findViewById(R.id.bmul)
        bminus = rootView.findViewById(R.id.bminus)
        bplus = rootView.findViewById(R.id.bplus)
        bequal = rootView.findViewById(R.id.bequal)
